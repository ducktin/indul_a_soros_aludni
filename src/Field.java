...
public class Field implements Visitable {
    ...
    public void setContent(Pushable pushable){
        if(pushable!=null){System.out.println("Field, "+ this.name + ", setContent, content: " + pushable.getName());}
        else{System.out.println("Field, "+ this.name + ", setContent, content: " + "NULL");}
